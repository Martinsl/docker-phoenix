...
For instance, for a dockerized development environment for Phoenix 1.5.6 you could run:
```
git clone -b 1.5.6 https://github.com/nicbet/docker-phoenix ~/Projects/hello-phoenix
```
